...
function TicketsAdmin() {
  ...
  const handleManualVerification = async () => {
    const code = window.prompt('Ange biljettkod (t.ex. TK-ABC123XY):')
    if (!code) return
    try {
        ...
        <div className="flex flex-col xl:flex-row justify-between xl:items-end gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              className="px-4 py-2.5 bg-primary text-primary-foreground text-xs uppercase tracking-widest font-medium hover:bg-primary/90 transition-all inline-flex items-center gap-2"
            >
                  ...
                  <td className="p-4 text-right">
                    <div className="flex justify-end gap-1">
                      ...
                      <button
                        ...
                        className="p-2 text-muted-foreground hover:text-primary hover:bg-secondary transition-all"
                        title="Visa QR"
                      >
            ...
            {verificationResult.ticket && (
              <div className="mt-6 text-left space-y-4 border-t border-border pt-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground">{getEventTitle(verificationResult.ticket.eventId) || 'Okänt event'}</p>
                </div>
            ...
            <div className="text-center space-y-6">
              <div>
                ...
                <p className="text-muted-foreground text-xs uppercase tracking-widest">
                  {getEventTitle(selectedTicket.eventId)}
                </p>
              </div>
